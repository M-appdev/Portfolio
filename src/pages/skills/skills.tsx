...
const SkillCard = (props: any) => {
    ...
    return (
        <div className="skill-card">
            {props.src ? <div><img className="card-image" src={props.src} alt="react-logo" width={75} /></div> : ""}
