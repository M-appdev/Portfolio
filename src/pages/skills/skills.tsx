    ...
    return (
        <div id="Skills" className="skills page page-centering">
            ...
            <div className="card-holder">
                ...
                <SkillCard title="HTML & CSS" description="Creating custom components with HTML & CSS to take websites to the next level" src="https://abdulhaseeb2017.files.wordpress.com/2017/03/html-css.jpg" />
                ...
                <SkillCard title="Amazon Web Services" description="Publishing a website to Amazon cloud services" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoDKw3FqxvEOMgO9NftJ31n-wBb7KNOe29CVD49c8r6pt28PvD4W4vtiJ6k2KbHa-KoLc&usqp=CAU" />
